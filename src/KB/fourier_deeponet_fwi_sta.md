# Fourier-DeepONet for Full Waveform Inversion (Style-A Dataset)
...
```python
# Training loop for Style-A dataset
def main(dataset='sta', task='loc_f'):
    # Load Style-A dataset (realistic geological formations) with varying source frequencies and locations
...
- **dataset**: Style-A (STA) - realistic geological formations inspired by natural images
